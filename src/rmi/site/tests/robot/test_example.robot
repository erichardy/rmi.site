...
#
#  $ bin/test -s rmi.site -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src rmi.site.testing.RMI_SITE_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/rmi/site/tests/robot/test_example.robot
#
